...
def main():
    ...
    openrouter_model = env_vars.get("OPENROUTER_MODEL", "anthropic/claude-3.5-sonnet")
    ...
    # Prepare YAML version with clean POSIX paths
    yaml_lines = [
        "# Goose Global Configuration (Generated by configure_environment.py)",
        "# Cross-Platform and OpenRouter Enabled",
        "",
        "GOOSE_PROVIDER: openrouter",
        f"GOOSE_MODEL: {openrouter_model}",
        "",
        "extensions:",
        "  developer:",
        "    enabled: true",
